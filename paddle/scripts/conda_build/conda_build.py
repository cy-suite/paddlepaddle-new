...
class ConstantVar:
    def __init__(self):
        self.py_str = ["py38", "py39", "py310", "py311", "py312", "py313"]
        self.pip_ver = ["3.8", "3.9", "3.10", "3.11", "3.12", "3.13"]
        self.cuda_info = ["cuda11.8", "cuda12.6"]
        self.py_ver = {
            "py38":"python>=3.8, <3.9",
...
def template_full(name, version, packages_string, python_version, cuda_str):
    ...
    elif cuda_str == "cuda12.6":
        paddlepaddle_cuda = '- paddlepaddle-cuda>=12.6,<12.7'
...
def gen_build_scripts(name, cuda_major_version, paddle_version, only_download=None):
    ...
    elif cuda_major_version == 'cuda12.6':
