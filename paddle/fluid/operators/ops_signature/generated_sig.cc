...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by AccuracyCheckOpArgumentMapping:

return KernelSignature("accuracy_check", {"x", "y"}, {"fn_name", "res_idx"}, {"out"});
******************************************************************
*/

KernelSignature AccuracyCheckOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "y"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("fn_name");
  attrs.emplace_back("res_idx");
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("accuracy_check", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by AdadeltaOpArgumentMapping:
...
KernelSignature AdadeltaOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Param", "Grad", "AvgSquaredGrad", "AvgSquaredUpdate", "LearningRate", "MasterParam"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("rho");
  attrs.emplace_back("epsilon");
  attrs.emplace_back("multi_precision");
  paddle::small_vector<const char*> outputs {"ParamOut", "AvgSquaredGradOut", "AvgSquaredUpdateOut", "MasterParamOut"};
  return KernelSignature("adadelta", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("argsort", {"X"}, {"axis", "descending", "stable"}, {"Out", "Indices"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by BoxClipOpArgumentMapping:

return KernelSignature("box_clip", {"Input", "ImInfo"}, {}, {"Output"});
******************************************************************
*/

KernelSignature BoxClipOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "ImInfo"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Output"};
  return KernelSignature("box_clip", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CorrelationOpArgumentMapping:

return KernelSignature("correlation", {"Input1", "Input2"}, {"pad_size", "kernel_size", "max_displacement", "stride1", "stride2", "corr_type_multiply"}, {"Output"});
******************************************************************
*/

KernelSignature CorrelationOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input1", "Input2"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("pad_size");
  attrs.emplace_back("kernel_size");
  attrs.emplace_back("max_displacement");
  attrs.emplace_back("stride1");
  attrs.emplace_back("stride2");
  attrs.emplace_back("corr_type_multiply");
  paddle::small_vector<const char*> outputs {"Output"};
  return KernelSignature("correlation", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CrfDecodingOpArgumentMapping:

return KernelSignature("crf_decoding", {"Emission", "Transition", "Label", "Length"}, {}, {"ViterbiPath"});
******************************************************************
*/

KernelSignature CrfDecodingOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Emission", "Transition", "Label", "Length"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"ViterbiPath"};
  return KernelSignature("crf_decoding", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CtcAlignOpArgumentMapping:

return KernelSignature("ctc_align", {"Input", "InputLength"}, {"blank", "merge_repeated", "padding_value"}, {"Output", "OutputLength"});
******************************************************************
*/

KernelSignature CtcAlignOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "InputLength"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("blank");
  attrs.emplace_back("merge_repeated");
  attrs.emplace_back("padding_value");
  paddle::small_vector<const char*> outputs {"Output", "OutputLength"};
  return KernelSignature("ctc_align", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CudnnLstmOpArgumentMapping:

return KernelSignature("cudnn_lstm", {"Input", "InitH", "InitC", "W", "WeightList", "SequenceLength"}, {"dropout_prob", "is_bidirec", "hidden_size", "num_layers", "is_test", "seed"}, {"Out", "LastH", "LastC", "Reserve", "StateOut"});
******************************************************************
*/

KernelSignature CudnnLstmOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "InitH", "InitC", "W", "WeightList", "SequenceLength"};
  paddle::small_vector<const char*> attrs;
  ...
  attrs.emplace_back("seed");
  paddle::small_vector<const char*> outputs {"Out", "LastH", "LastC", "Reserve", "StateOut"};
  return KernelSignature("cudnn_lstm", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("cumprod", {"X"}, {"dim", "exclusive", "reverse"}, {"Out"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by DependOpArgumentMapping:

return KernelSignature("depend", {"X", "Dep"}, {}, {"Out"});
******************************************************************
*/

KernelSignature DependOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Dep"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("depend", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by DequantizeAbsMaxOpArgumentMapping:

return KernelSignature("dequantize_abs_max", {"X", "Scale"}, {"max_range"}, {"Out"});
******************************************************************
*/

KernelSignature DequantizeAbsMaxOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Scale"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("max_range");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("dequantize_abs_max", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by DetectionMapOpArgumentMapping:

return KernelSignature("detection_map", {"DetectRes", "Label", "HasState", "PosCount", "TruePos", "FalsePos"}, {"class_num", "background_label", "overlap_threshold", "evaluate_difficult", "ap_type"}, {"AccumPosCount", "AccumTruePos", "AccumFalsePos", "MAP"});
******************************************************************
*/

KernelSignature DetectionMapOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"DetectRes", "Label", "HasState", "PosCount", "TruePos", "FalsePos"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("class_num");
  attrs.emplace_back("background_label");
  attrs.emplace_back("overlap_threshold");
  attrs.emplace_back("evaluate_difficult");
  attrs.emplace_back("ap_type");
  paddle::small_vector<const char*> outputs {"AccumPosCount", "AccumTruePos", "AccumFalsePos", "MAP"};
  return KernelSignature("detection_map", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by DgcMomentumOpArgumentMapping:

return KernelSignature("dgc_momentum", {"Param", "Grad", "Velocity", "LearningRate", "MasterParam", "current_step", "nranks"}, {"mu", "use_nesterov", "regularization_method", "regularization_coeff", "multi_precision", "rescale_grad", "rampup_begin_step"}, {"ParamOut", "VelocityOut", "MasterParamOut", "Grad_out"});
******************************************************************
*/

KernelSignature DgcMomentumOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Param", "Grad", "Velocity", "LearningRate", "MasterParam", "current_step", "nranks"};
  paddle::small_vector<const char*> attrs;
  ...
  attrs.emplace_back("rampup_begin_step");
  paddle::small_vector<const char*> outputs {"ParamOut", "VelocityOut", "MasterParamOut", "Grad_out"};
  return KernelSignature("dgc_momentum", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeChannelWiseQuantizeAbsMaxOpArgumentMapping:

return KernelSignature("fake_channel_wise_quantize_abs_max", {"X"}, {"bit_length", "round_type", "quant_axis", "is_test"}, {"Out", "OutScale"});
******************************************************************
*/

KernelSignature FakeChannelWiseQuantizeAbsMaxOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("bit_length");
  attrs.emplace_back("round_type");
  attrs.emplace_back("quant_axis");
  attrs.emplace_back("is_test");
  paddle::small_vector<const char*> outputs {"Out", "OutScale"};
  return KernelSignature("fake_channel_wise_quantize_abs_max", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeChannelWiseQuantizeDequantizeAbsMaxOpArgumentMapping:

return KernelSignature("fake_channel_wise_quantize_dequantize_abs_max", {"X"}, {"bit_length", "round_type", "quant_axis"}, {"Out", "OutScale"});
******************************************************************
*/

KernelSignature FakeChannelWiseQuantizeDequantizeAbsMaxOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("bit_length");
  attrs.emplace_back("round_type");
  attrs.emplace_back("quant_axis");
  paddle::small_vector<const char*> outputs {"Out", "OutScale"};
  return KernelSignature("fake_channel_wise_quantize_dequantize_abs_max", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeQuantizeAbsMaxOpArgumentMapping:

return KernelSignature("fake_quantize_abs_max", {"X"}, {"bit_length", "round_type"}, {"Out", "OutScale"});
******************************************************************
*/

KernelSignature FakeQuantizeAbsMaxOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("bit_length");
  attrs.emplace_back("round_type");
  paddle::small_vector<const char*> outputs {"Out", "OutScale"};
  return KernelSignature("fake_quantize_abs_max", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeQuantizeMovingAverageAbsMaxOpArgumentMapping:

return KernelSignature("fake_quantize_moving_average_abs_max", {"X", "InScale", "InAccum", "InState"}, {"moving_rate", "bit_length", "is_test", "round_type"}, {"Out", "OutScale", "OutState", "OutAccum"});
******************************************************************
*/

KernelSignature FakeQuantizeMovingAverageAbsMaxOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "InScale", "InAccum", "InState"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("moving_rate");
  attrs.emplace_back("bit_length");
  attrs.emplace_back("is_test");
  attrs.emplace_back("round_type");
  paddle::small_vector<const char*> outputs {"Out", "OutScale", "OutState", "OutAccum"};
  return KernelSignature("fake_quantize_moving_average_abs_max", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeQuantizeRangeAbsMaxOpArgumentMapping:

return KernelSignature("fake_quantize_range_abs_max", {"X", "InScale", "Iter"}, {"window_size", "bit_length", "is_test", "round_type"}, {"Out", "OutScale", "OutScales"});
******************************************************************
*/

KernelSignature FakeQuantizeRangeAbsMaxOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "InScale", "Iter"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("window_size");
  attrs.emplace_back("bit_length");
  attrs.emplace_back("is_test");
  attrs.emplace_back("round_type");
  paddle::small_vector<const char*> outputs {"Out", "OutScale", "OutScales"};
  return KernelSignature("fake_quantize_range_abs_max", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FlashAttnQkvpackedOpArgumentMapping:

return KernelSignature("flash_attn_qkvpacked", {"qkv", "fixed_seed_offset", "attn_mask"}, {"dropout", "causal", "return_softmax", "is_test", "rng_name"}, {"out", "softmax", "softmax_lse", "seed_offset"});
******************************************************************
*/

KernelSignature FlashAttnQkvpackedOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"qkv", "fixed_seed_offset", "attn_mask"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("dropout");
  attrs.emplace_back("causal");
  attrs.emplace_back("return_softmax");
  ...
  attrs.emplace_back("rng_name");
  paddle::small_vector<const char*> outputs {"out", "softmax", "softmax_lse", "seed_offset"};
  return KernelSignature("flash_attn_qkvpacked", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FlashAttnVarlenQkvpackedOpArgumentMapping:

return KernelSignature("flash_attn_varlen_qkvpacked", {"qkv", "cu_seqlens_q", "cu_seqlens_k", "fixed_seed_offset", "attn_mask"}, {"max_seqlen_q", "max_seqlen_k", "scale", "dropout", "causal", "return_softmax", "is_test", "rng_name", "varlen_padded"}, {"out", "softmax", "softmax_lse", "seed_offset"});
******************************************************************
*/

KernelSignature FlashAttnVarlenQkvpackedOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"qkv", "cu_seqlens_q", "cu_seqlens_k", "fixed_seed_offset", "attn_mask"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("max_seqlen_q");
  attrs.emplace_back("max_seqlen_k");
  attrs.emplace_back("scale");
  ...
  attrs.emplace_back("is_test");
  attrs.emplace_back("rng_name");
  attrs.emplace_back("varlen_padded");
  paddle::small_vector<const char*> outputs {"out", "softmax", "softmax_lse", "seed_offset"};
  return KernelSignature("flash_attn_varlen_qkvpacked", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("kldiv_loss", {"X", "Target"}, {"reduction", "log_target"}, {"Loss"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by L1NormOpArgumentMapping:

return KernelSignature("l1_norm", {"X"}, {}, {"Out"});
******************************************************************
*/

KernelSignature L1NormOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("l1_norm", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by NadamOpArgumentMapping:

return KernelSignature("nadam", {"param", "grad", "learning_rate", "momentum_decay_pow", "beta2_pow", "mu_product", "moment1", "moment2", "master_param"}, {"beta1", "beta2", "epsilon", "momentum_decay", "multi_precision"}, {"param_out", "momentum_decay_pow_out", "beta2_pow_out", "mu_product_out", "moment1_out", "moment2_out", "master_param_out"});
******************************************************************
*/

KernelSignature NadamOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"param", "grad", "learning_rate", "momentum_decay_pow", "beta2_pow", "mu_product", "moment1", "moment2", "master_param"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("beta1");
  attrs.emplace_back("beta2");
  attrs.emplace_back("epsilon");
  attrs.emplace_back("momentum_decay");
  attrs.emplace_back("multi_precision");
  paddle::small_vector<const char*> outputs {"param_out", "momentum_decay_pow_out", "beta2_pow_out", "mu_product_out", "moment1_out", "moment2_out", "master_param_out"};
  return KernelSignature("nadam", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by PartialConcatOpArgumentMapping:

return KernelSignature("partial_concat", {"X"}, {"start_index", "length"}, {"Out"});
******************************************************************
*/

KernelSignature PartialConcatOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("start_index");
  attrs.emplace_back("length");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("partial_concat", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by PartialSumOpArgumentMapping:

return KernelSignature("partial_sum", {"X"}, {"start_index", "length"}, {"Out"});
******************************************************************
*/

KernelSignature PartialSumOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("start_index");
  attrs.emplace_back("length");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("partial_sum", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by RadamOpArgumentMapping:

return KernelSignature("radam", {"param", "grad", "learning_rate", "beta1_pow", "beta2_pow", "rho", "moment1", "moment2", "master_param"}, {"beta1", "beta2", "epsilon", "multi_precision"}, {"param_out", "beta1_pow_out", "beta2_pow_out", "rho_out", "moment1_out", "moment2_out", "master_param_out"});
******************************************************************
*/

KernelSignature RadamOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"param", "grad", "learning_rate", "beta1_pow", "beta2_pow", "rho", "moment1", "moment2", "master_param"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("beta1");
  attrs.emplace_back("beta2");
  attrs.emplace_back("epsilon");
  attrs.emplace_back("multi_precision");
  paddle::small_vector<const char*> outputs {"param_out", "beta1_pow_out", "beta2_pow_out", "rho_out", "moment1_out", "moment2_out", "master_param_out"};
  return KernelSignature("radam", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by RandomRoutingOpArgumentMapping:

return KernelSignature("random_routing", {"Prob", "TopK_Value", "TopK_Idx"}, {}, {"Out"});
******************************************************************
*/

KernelSignature RandomRoutingOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Prob", "TopK_Value", "TopK_Idx"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("random_routing", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ReduceAsOpArgumentMapping:

return KernelSignature("reduce_as", {"x", "target"}, {}, {"out"});
******************************************************************
*/

KernelSignature ReduceAsOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "target"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("reduce_as", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by SparseAttentionOpArgumentMapping:

return KernelSignature("sparse_attention", {"Q", "K", "V", "Offset", "Columns", "KeyPaddingMask", "AttnMask"}, {}, {"Out", "SparseDotSdd", "Softmax"});
******************************************************************
*/

KernelSignature SparseAttentionOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Q", "K", "V", "Offset", "Columns", "KeyPaddingMask", "AttnMask"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Out", "SparseDotSdd", "Softmax"};
  return KernelSignature("sparse_attention", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by StftOpArgumentMapping:

return KernelSignature("stft", {"X", "Window"}, {"n_fft", "hop_length", "normalized", "onesided"}, {"Out"});
******************************************************************
*/

KernelSignature StftOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Window"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("n_fft");
  attrs.emplace_back("hop_length");
  attrs.emplace_back("normalized");
  attrs.emplace_back("onesided");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("stft", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by YoloBoxHeadOpArgumentMapping:

return KernelSignature("yolo_box_head", {"X"}, {"anchors", "class_num"}, {"Out"});
******************************************************************
*/

KernelSignature YoloBoxHeadOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("anchors");
  attrs.emplace_back("class_num");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("yolo_box_head", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by YoloBoxPostOpArgumentMapping:

return KernelSignature("yolo_box_post", {"Boxes0", "Boxes1", "Boxes2", "ImageShape", "ImageScale"}, {"anchors0", "anchors1", "anchors2", "class_num", "conf_thresh", "downsample_ratio0", "downsample_ratio1", "downsample_ratio2", "clip_bbox", "scale_x_y", "nms_threshold"}, {"Out", "NmsRoisNum"});
******************************************************************
*/

KernelSignature YoloBoxPostOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Boxes0", "Boxes1", "Boxes2", "ImageShape", "ImageScale"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("anchors0");
  attrs.emplace_back("anchors1");
  attrs.emplace_back("anchors2");
  attrs.emplace_back("class_num");
  attrs.emplace_back("conf_thresh");
  attrs.emplace_back("downsample_ratio0");
  attrs.emplace_back("downsample_ratio1");
  attrs.emplace_back("downsample_ratio2");
  attrs.emplace_back("clip_bbox");
  attrs.emplace_back("scale_x_y");
  attrs.emplace_back("nms_threshold");
  paddle::small_vector<const char*> outputs {"Out", "NmsRoisNum"};
  return KernelSignature("yolo_box_post", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ChunkEvalOpArgumentMapping:

return KernelSignature("chunk_eval", {"Inference", "Label", "SeqLength"}, {"num_chunk_types", "chunk_scheme", "excluded_chunk_types"}, {"Precision", "Recall", "F1-Score", "NumInferChunks", "NumLabelChunks", "NumCorrectChunks"});
******************************************************************
*/

KernelSignature ChunkEvalOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Inference", "Label", "SeqLength"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("num_chunk_types");
  attrs.emplace_back("chunk_scheme");
  attrs.emplace_back("excluded_chunk_types");
  paddle::small_vector<const char*> outputs {"Precision", "Recall", "F1-Score", "NumInferChunks", "NumLabelChunks", "NumCorrectChunks"};
  return KernelSignature("chunk_eval", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by MoeOpArgumentMapping:

return KernelSignature("moe", {"X", "Gate", "Bmm0", "Bias0", "Bmm1", "Bias1"}, {"act_type"}, {"Out"});
******************************************************************
*/

KernelSignature MoeOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Gate", "Bmm0", "Bias0", "Bmm1", "Bias1"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("act_type");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("moe", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("argsort_grad", {"Indices", "X", "Out@GRAD"}, {"axis", "descending", "stable"}, {"X@GRAD"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CorrelationGradOpArgumentMapping:

return KernelSignature("correlation_grad", {"Input1", "Input2", "Output@GRAD"}, {"pad_size", "kernel_size", "max_displacement", "stride1", "stride2", "corr_type_multiply"}, {"Input1@GRAD", "Input2@GRAD"});
******************************************************************
*/

KernelSignature CorrelationGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input1", "Input2", "Output@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("pad_size");
  attrs.emplace_back("kernel_size");
  attrs.emplace_back("max_displacement");
  ...
  attrs.emplace_back("stride2");
  attrs.emplace_back("corr_type_multiply");
  paddle::small_vector<const char*> outputs {"Input1@GRAD", "Input2@GRAD"};
  return KernelSignature("correlation_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CudnnLstmGradOpArgumentMapping:

return KernelSignature("cudnn_lstm_grad", {"Input", "InitH", "InitC", "WeightList", "SequenceLength", "Out", "Reserve", "StateOut", "Out@GRAD", "LastH@GRAD", "LastC@GRAD"}, {"dropout_prob", "is_bidirec", "hidden_size", "num_layers", "is_test", "seed"}, {"Input@GRAD", "InitH@GRAD", "InitC@GRAD", "WeightList@GRAD"});
******************************************************************
*/

KernelSignature CudnnLstmGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "InitH", "InitC", "WeightList", "SequenceLength", "Out", "Reserve", "StateOut", "Out@GRAD", "LastH@GRAD", "LastC@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("dropout_prob");
  attrs.emplace_back("is_bidirec");
  attrs.emplace_back("hidden_size");
  ...
  attrs.emplace_back("is_test");
  attrs.emplace_back("seed");
  paddle::small_vector<const char*> outputs {"Input@GRAD", "InitH@GRAD", "InitC@GRAD", "WeightList@GRAD"};
  return KernelSignature("cudnn_lstm_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("cumprod_grad", {"X", "Out", "Out@GRAD"}, {"dim", "exclusive", "reverse"}, {"X@GRAD"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeChannelWiseQuantizeDequantizeAbsMaxGradOpArgumentMapping:

return KernelSignature("fake_channel_wise_quantize_dequantize_abs_max_grad", {"Out@GRAD"}, {"bit_length", "round_type", "quant_axis"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature FakeChannelWiseQuantizeDequantizeAbsMaxGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("bit_length");
  attrs.emplace_back("round_type");
  attrs.emplace_back("quant_axis");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("fake_channel_wise_quantize_dequantize_abs_max_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FlashAttnQkvpackedGradOpArgumentMapping:

return KernelSignature("flash_attn_qkvpacked_grad", {"qkv", "out", "softmax_lse", "seed_offset", "attn_mask", "out@GRAD"}, {"dropout", "causal"}, {"qkv@GRAD"});
******************************************************************
*/

KernelSignature FlashAttnQkvpackedGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"qkv", "out", "softmax_lse", "seed_offset", "attn_mask", "out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("dropout");
  attrs.emplace_back("causal");
  paddle::small_vector<const char*> outputs {"qkv@GRAD"};
  return KernelSignature("flash_attn_qkvpacked_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FlashAttnVarlenQkvpackedGradOpArgumentMapping:

return KernelSignature("flash_attn_varlen_qkvpacked_grad", {"qkv", "cu_seqlens_q", "cu_seqlens_k", "out", "softmax_lse", "seed_offset", "attn_mask", "out@GRAD"}, {"max_seqlen_q", "max_seqlen_k", "scale", "dropout", "causal", "varlen_padded"}, {"qkv@GRAD"});
******************************************************************
*/

KernelSignature FlashAttnVarlenQkvpackedGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"qkv", "cu_seqlens_q", "cu_seqlens_k", "out", "softmax_lse", "seed_offset", "attn_mask", "out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("max_seqlen_q");
  attrs.emplace_back("max_seqlen_k");
  attrs.emplace_back("scale");
  ...
  attrs.emplace_back("varlen_padded");
  paddle::small_vector<const char*> outputs {"qkv@GRAD"};
  return KernelSignature("flash_attn_varlen_qkvpacked_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("kldiv_loss_grad", {"X", "Target", "Loss@GRAD"}, {"reduction", "log_target"}, {"X@GRAD"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by L1NormGradOpArgumentMapping:

return KernelSignature("l1_norm_grad", {"X", "Out@GRAD"}, {}, {"X@GRAD"});
******************************************************************
*/

KernelSignature L1NormGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("l1_norm_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by PartialConcatGradOpArgumentMapping:

return KernelSignature("partial_concat_grad", {"X", "Out@GRAD"}, {"start_index", "length"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature PartialConcatGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("start_index");
  attrs.emplace_back("length");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("partial_concat_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by PartialSumGradOpArgumentMapping:

return KernelSignature("partial_sum_grad", {"X", "Out@GRAD"}, {"start_index", "length"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature PartialSumGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("start_index");
  attrs.emplace_back("length");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("partial_sum_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by PushGpupsSparseOpArgumentMapping:

return KernelSignature("push_gpups_sparse", {"ids", "out@GRAD"}, {"size", "is_sparse", "is_distributed"}, {"out_grad@GRAD"});
******************************************************************
*/

KernelSignature PushGpupsSparseOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"ids", "out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("size");
  attrs.emplace_back("is_sparse");
  attrs.emplace_back("is_distributed");
  paddle::small_vector<const char*> outputs {"out_grad@GRAD"};
  return KernelSignature("push_gpups_sparse", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ReduceAsGradOpArgumentMapping:

return KernelSignature("reduce_as_grad", {"x", "target", "out@GRAD"}, {}, {"x@GRAD"});
******************************************************************
*/

KernelSignature ReduceAsGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "target", "out@GRAD"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"x@GRAD"};
  return KernelSignature("reduce_as_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by SparseAttentionGradOpArgumentMapping:

return KernelSignature("sparse_attention_grad", {"Q", "K", "V", "Offset", "Columns", "SparseDotSdd", "Softmax", "Out@GRAD"}, {}, {"Q@GRAD", "K@GRAD", "V@GRAD"});
******************************************************************
*/

KernelSignature SparseAttentionGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Q", "K", "V", "Offset", "Columns", "SparseDotSdd", "Softmax", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Q@GRAD", "K@GRAD", "V@GRAD"};
  return KernelSignature("sparse_attention_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by StftGradOpArgumentMapping:

return KernelSignature("stft_grad", {"X", "Window", "Out@GRAD"}, {"n_fft", "hop_length", "normalized", "onesided"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature StftGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Window", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("n_fft");
  attrs.emplace_back("hop_length");
  attrs.emplace_back("normalized");
  attrs.emplace_back("onesided");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("stft_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
PD_REGISTER_ARG_MAPPING_FN(accuracy_check, phi::AccuracyCheckOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(box_clip, phi::BoxClipOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(crf_decoding, phi::CrfDecodingOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(ctc_align, phi::CtcAlignOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(depend, phi::DependOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(depthwise_conv2d, phi::DepthwiseConv2dOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(dequantize_abs_max, phi::DequantizeAbsMaxOpArgumentMapping);
PD_REGISTER_BASE_KERNEL_NAME(determinant, det);
PD_REGISTER_ARG_MAPPING_FN(determinant, phi::DeterminantOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(detection_map, phi::DetectionMapOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(fake_channel_wise_quantize_abs_max, phi::FakeChannelWiseQuantizeAbsMaxOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(fake_channel_wise_quantize_dequantize_abs_max, phi::FakeChannelWiseQuantizeDequantizeAbsMaxOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(fake_quantize_abs_max, phi::FakeQuantizeAbsMaxOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(fake_quantize_moving_average_abs_max, phi::FakeQuantizeMovingAverageAbsMaxOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(fake_quantize_range_abs_max, phi::FakeQuantizeRangeAbsMaxOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(flash_attn_qkvpacked, phi::FlashAttnQkvpackedOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(flash_attn_unpadded, phi::FlashAttnUnpaddedOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(flash_attn_varlen_qkvpacked, phi::FlashAttnVarlenQkvpackedOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(l1_norm, phi::L1NormOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(nadam, phi::NadamOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(partial_concat, phi::PartialConcatOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(radam, phi::RadamOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(reduce_as, phi::ReduceAsOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(sparse_attention, phi::SparseAttentionOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(yolo_box_head, phi::YoloBoxHeadOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(yolo_box_post, phi::YoloBoxPostOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(moe, phi::MoeOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(correlation_grad, phi::CorrelationGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(cudnn_lstm_grad, phi::CudnnLstmGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(fake_channel_wise_quantize_dequantize_abs_max_grad, phi::FakeChannelWiseQuantizeDequantizeAbsMaxGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(flash_attn_qkvpacked_grad, phi::FlashAttnQkvpackedGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(flash_attn_unpadded_grad, phi::FlashAttnUnpaddedGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(flash_attn_varlen_qkvpacked_grad, phi::FlashAttnVarlenQkvpackedGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(l1_norm_grad, phi::L1NormGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(partial_concat_grad, phi::PartialConcatGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(partial_sum_grad, phi::PartialSumGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(push_gpups_sparse, phi::PushGpupsSparseOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(reduce_as_grad, phi::ReduceAsGradOpArgumentMapping);
