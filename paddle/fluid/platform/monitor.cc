...
DEFINE_INT_STATUS(STAT_xpu0_mem_size)
DEFINE_INT_STATUS(STAT_xpu1_mem_size)
DEFINE_INT_STATUS(STAT_xpu2_mem_size)
DEFINE_INT_STATUS(STAT_xpu3_mem_size)
DEFINE_INT_STATUS(STAT_xpu4_mem_size)
DEFINE_INT_STATUS(STAT_xpu5_mem_size)
DEFINE_INT_STATUS(STAT_xpu6_mem_size)
DEFINE_INT_STATUS(STAT_xpu7_mem_size)
