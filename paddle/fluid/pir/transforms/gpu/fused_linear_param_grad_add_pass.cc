...
// matmul_grad + add_ -> matmul + fused_liner_param_grad_add
...
// matmul + 0 = add_(0,1) -> fused_liner_param_grad_add
...
// matmul + 1 = add_(1,0) -> fused_liner_param_grad_add
...
// add_grad + matmul + 0 = add_(0,1) -> fused_liner_param_grad_add
...
// add_grad + matmul + 1 = add_(1,0) -> fused_liner_param_grad_add
