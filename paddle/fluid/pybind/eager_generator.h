...
std::map<std::string, std::set<std::string>> op_ins_map = {
    ...
    {"fused_multi_transformer_dybatch",
     {"X",
      ...
      "CumOffsetsMerged",
      "PaddingOffsetMerged",
      "SeqLengthsThisTimeMerged",
      "SeqLengthsEncoderMerged",
      "SeqLengthsDecoderMerged",
      "SeqMapping",
      "SystemLens",
      "SystemLensMerged",
      "GroupIds",
      "SeqLengthsEncoderCum",
      "SeqLengthsDecoderCum",
      "SrcMask",
      "TgtMask",
      "BlockTables",
      "ExcessBlocks",
...
std::map<std::string, std::set<std::string>> op_outs_map = {
    ...
    {"fused_multi_transformer_dybatch", {"CacheKVOut", "Out"}},
    {"resnet_basic_block",
...
std::map<std::string, std::set<std::string>> op_passing_outs_map = {
    ...
    {"fused_multi_transformer_dybatch", {"CacheKVOut"}},
