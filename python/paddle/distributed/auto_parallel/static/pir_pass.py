...
def _set_process_mesh_and_chunk_id(op, process_mesh, chunk_id, set_mesh):
    ...
    def get_var_process_mesh(var_dist_attr, var_origin_op):
    ...
    def set_process_mesh(vars, attrs):
        for idx, (var, attr) in enumerate(zip(vars, attrs)):
            ...
            # NOTE(zhangwl): op var may is vec_type
            if var_dist_attr:
                var_attr = get_var_process_mesh(var_dist_attr, var_origin_op)
                ...
                for combine_var in var_list:
                    ...
                    var_attr_list.append(
                        get_var_process_mesh(var_dist_attr, var_origin_op)
                    )
                var_array_attr = (
