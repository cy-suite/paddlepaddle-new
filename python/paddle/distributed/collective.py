...
if TYPE_CHECKING:
    _BackendList: TypeAlias = Literal["gloo", "nccl", "xccl", "bkcl", "ucc"]
__all__ = []
...
_valid_backend_list = ['nccl', 'gloo', 'heter', 'xccl', 'bkcl', 'ucc']
...
def _new_process_group_impl(
    ...
    if backend == "gloo":
        ...
        pg = core.ProcessGroupUCC.create(store, rank, world_size, group_id)
    return pg
