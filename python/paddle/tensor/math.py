...
def clip(
    ...
    if (isinstance(min, (paddle.pir.Value, paddle.Tensor)) and (min.shape != [1] or min.shape != [0] or min.shape != [])) or (
        isinstance(max, (paddle.pir.Value, paddle.Tensor)) and (max.shape != [1] or max.shape != [0] or max.shape != [])
    ):
