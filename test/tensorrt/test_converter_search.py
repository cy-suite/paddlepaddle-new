...
class TestArgminFloatTRTPattern(TensorRTBaseTest):
    def setUp(self):
...
class TestArgminIntTRTPattern(TensorRTBaseTest):
    def setUp(self):
        self.python_api = paddle.argmin
        self.api_args = {
...
class TestArgsortFloatTRTPattern(TensorRTBaseTest):
    def setUp(self):
...
class TestArgsortIntTRTPattern(TensorRTBaseTest):
    def setUp(self):
        self.python_api = paddle.argsort
        self.api_args = {
            "x": np.random.randn(2, 3).astype("int64"),
