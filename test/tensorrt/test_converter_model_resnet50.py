...
class TestConverterResNet50(unittest.TestCase):
    ...
    def test_refit(self):
        ...
        trt_save_path = os.path.join('./opt_cache', 'resnet50trt')
        trt_config.save_model_dir = trt_save_path
        trt_config.refit_params_path = './opt_cache/resnet50.pdiparams'
        model_dir = './opt_cache/resnet50'
        ...
        config.delete_pass("con1d_add_act_fuse_pass")
        ...
        for i, input_instrance in enumerate(trt_config.inputs):
            ...
            output_trt = predictor.run([model_inputs])
