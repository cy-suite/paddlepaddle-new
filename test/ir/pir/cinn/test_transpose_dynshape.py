...
class TestTransposeDynShape(unittest.TestCase):
    def eval(self, dy_compute, inputs, input_spec):
    ...
    def test_self_cross(self):
        ...
        x_spec = InputSpec(shape=[None, 200, 200])

        self.eval(func, [x], [x_spec])

    def test_small_0231(self):
        def func(x):
