...
class TrtConvertInstanceNormTest(TrtLayerAutoScanTest):
    ...
    def generate_dynamic_shape(self):
        if self.in_dim == 2:
            ...
            self.dynamic_shape.min_input_shape = {"input_data": [2, 3, 32]}
            self.dynamic_shape.max_input_shape = {"input_data": [2, 3, 32]}
            self.dynamic_shape.opt_input_shape = {"input_data": [2, 3, 32]}
        elif self.in_dim == 4:
            self.dynamic_shape.min_input_shape = {"input_data": [2, 3, 32, 32]}
