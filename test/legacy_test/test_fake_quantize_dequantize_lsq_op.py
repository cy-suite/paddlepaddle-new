...
class TestLsq(unittest.TestCase):
    ...
    def run_dyamic(
        ...
        place = paddle.CUDAPlace(0) if place == 'gpu' else paddle.CPUPlace()
    ...
    def run_fake_quant(
        ...
        input_data = distributions[0](input_shape).astype(dtype)
        scale = distributions[1]([1]).astype(dtype)
        lsq_factor = distributions[2]([1]).astype('float32')
    ...
    def test_fake_quantize_dequantize_dygraph_fp16(self):
        distributions = [
            np.random.random,
            np.random.random,
            np.random.random,
    ...
    def test_fake_quantize_dequantize_dygraph_cpu(self):
        distributions = [
            np.random.random,
            np.random.random,
            np.random.random,
    ...
    def test_fake_quantize_dequantize_static_cpu(self):
        distributions = [
            np.random.random,
            np.random.random,
            np.random.random,
    ...
    def test_fake_quantize_dequantize_round1_cpu(self):
        distributions = [
            np.random.random,
            np.random.random,
            np.random.random,
