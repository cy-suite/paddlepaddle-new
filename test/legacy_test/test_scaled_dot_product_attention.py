...
class TestScaledDotProductAttentionWithMaskAPI(unittest.TestCase):
    def setUp(self):
...
class TestSDPAttentionAPIMath(TestScaledDotProductAttentionWithMaskAPI):
    def setUp(self):
...
class TestSDPAttentionAPIFP32(TestScaledDotProductAttentionWithMaskAPI):
    def setUp(self):
        self.place = paddle.CUDAPlace(0)
        self.shape = (8, 1024, 16, 128)
        self.dtype = 'float32'
